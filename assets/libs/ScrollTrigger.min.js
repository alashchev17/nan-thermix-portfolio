...
!(function (e, t) {
  ...
  function G(r, n) {
    function dd(e) {
      if (e || 0 === e) {
        ...
        ;(e = dd.v = Math.round(e) || (Be && Be.iOS ? 1 : 0)),
          r(e),
          (dd.cacheID = Ie.cache),
          t && i('ss', e)
  ...
  function J(e, t) {
    return (
      ((t && t._ctx && t._ctx.selector) || _e.utils.toArray)(e)[0] ||
      ('string' == typeof e && !1 !== _e.config().nullTargetWarn
  ...
  function K(t, e) {
    ...
    return (
      (s.target = t),
      a || (s.smooth = 'smooth' === _e.getProperty(t, 'scrollBehavior')),
      s
    )
  }
  function L(e, t, o) {
  ...
  function O() {
    ;(Oe = _e.core.globals().ScrollTrigger) &&
      Oe.core &&
      (function _integrate() {
        var e = Oe.core,
          r = e.bridge || {},
  ...
  function P(e) {
    return (
      ...
      !Te &&
        ...
        document.body &&
        ((Ce = window),
        (ke = (Se = document).documentElement),
        (Pe = Se.body),
        (t = [Ce, Se, ke, Pe]),
        _e.utils.clamp,
        (De = _e.core.context || function () {}),
        (Ee = 'onpointerenter' in Pe ? 'pointer' : 'mouse'),
        (Me = k.isTouch =
          Ce.matchMedia &&
    ...
    ze = {
      ...
      sc: G(function (e) {
        return arguments.length
          ? Ce.scrollTo(e, Ye.sc())
          : Ce.pageXOffset || Se[n] || ke[n] || Pe[n] || 0
      }),
    },
    Ye = {
      s: a,
      ...
      sc: G(function (e) {
        return arguments.length
          ? Ce.scrollTo(ze.sc(), e)
          : Ce.pageYOffset || Se[a] || ke[a] || Pe[a] || 0
      }),
    }
  ;(ze.op = Ye), (Ie.cache = 0)
  var k =
    ((Observer.prototype.init = function init(e) {
      Te || P(_e) || console.warn('Please gsap.registerPlugin(Observer)'),
        Oe || O()
      var o = e.tolerance,
        a = e.dragMinimum,
        t = e.type,
      ...
      function ef() {
        ...
        S && (r || n) && S(se, e, t, be, me),
          ...
          n &&
            ...
            (ce = se.deltaY),
            (me[0] = me[1] = me[2] = 0)),
          (ne || re) && (I && I(se), re && (h(se), (re = !1)), (ne = !1)),
          ie && !(ie = !1) && $ && $(se),
          oe && (X(se), (oe = !1)),
          (ee = 0)
      }
      function ff(e, t, r) {
        ;(be[r] += e),
          ...
          se._vx.update(e),
          se._vy.update(t),
          n ? (ee = ee || requestAnimationFrame(ef)) : ef()
      }
      function gf(e, t) {
        Z &&
          !ae &&
      ...
      function of(e) {
        if (!cf(e)) {
          ;(e = M(e, s)), X && (oe = !0)
          var t =
            (1 === e.deltaMode ? r : 2 === e.deltaMode ? Ce.innerHeight : 1) * f
      ...
      ;(this.target = i = J(i) || ke),
        ...
        (n = !1 !== n),
        (r = r || parseFloat(Ce.getComputedStyle(Pe).lineHeight) || 22)
      var ee,
        te,
        re,
        ne,
      ...
      ;(te = se._dc =
        ...
        (se.enable = function (e) {
          return (
            se.isEnabled ||
              (B(he ? ve : i, 'scroll', F),
              0 <= t.indexOf('scroll') && B(he ? ve : i, 'scroll', nf, s, j),
              0 <= t.indexOf('wheel') && B(i, 'wheel', of, s, j),
              ((0 <= t.indexOf('touch') && Me) || 0 <= t.indexOf('pointer')) &&
                ...
                Q && B(i, 'click', bf, !1, !0),
                U && B(i, 'click', sf),
                Y && B(ve, 'gesturestart', lf),
                H && B(ve, 'gestureend', mf),
                D && B(i, Ee + 'enter', qf),
                R && B(i, Ee + 'leave', rf),
                I && B(i, Ee + 'move', pf)),
              (se.isEnabled = !0),
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed &&
              (se._vx.reset(), se._vy.reset(), C(z ? i : ve, Ae[1], hf, !0)),
            C(he ? ve : i, 'scroll', nf, j),
            C(i, 'wheel', of, j),
            C(i, Ae[0], xe, j),
            C(ve, Ae[2], we),
            C(ve, Ae[3], we),
  ...
  function Sb(e, t) {
    ...
    for (je = 0; je < Tt.length; je++)
      !(r = Tt[je]) || (t && r._ctx !== t) || (e ? r.kill(1) : r.revert(!0, !0))
  ...
  function Yb() {
    We.appendChild(_),
      (T = (!v && _.offsetHeight) || He.innerHeight),
      We.removeChild(_)
  }
  function Zb(t) {
    return Je(
    ...
    if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), i)) {
      ...
      ;(g = 'scroll' + n.d2),
        X(
          ...
          n,
          (C && 20 < T) ||
            (!C && (u ? Math.max(We[g], Xe[g]) : i.parentNode[g]) <= T + 1)
        ),
        u &&
          ((l = xt(a)),
          u && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + yt))
    }
    return (
      d &&
        v &&
  ...
  var Fe,
    ...
    Z = function _updateAll(e) {
      if (2 === e || (!tt && !S)) {
        ...
        if (
          ...
          tt || (Q = o),
          n &&
            (at && !Ge && 200 < r - at && ((at = 0), U('scrollEnd')),
            (Ue = R),
            (R = r)),
          Pt < 0)
        ) {
          ...
          Pt = 1
        } else for (je = 0; je < t; je++) Tt[je] && Tt[je].update(0, n)
        ne.isUpdating = !1
      }
      D = 0
    },
    ...
    Mt = function _setState(e) {
      if (e) {
        var t,
          ...
          o = e.length,
          i = 0
        for ((e.t._gsap || Fe.core.getCache(e.t)).uncache = 1; i < o; i += 2)
          (r = e[i + 1]),
            (t = e[i]),
            r
              ? (n[t] = r)
    ...
    ne =
      ((ScrollTrigger.prototype.init = function init(E, O) {
        if (
          ((this.progress = this.start = 0), this.vars && this.kill(!0, !0), st)
        ) {
          var B,
            n,
            p,
            ...
            T,
            i,
            C = (E = ob(lt(E) || Ua(E) || E.nodeType ? { trigger: E } : E, _t))
              .onUpdate,
            S = E.toggleClass,
            a = E.id,
            k = E.onToggle,
          ...
          if (
            ...
            (M *= 45),
            (Ce.scroller = be),
            (Ce.scroll = de ? de.time.bind(de) : Be),
            (A = Be()),
            (Ce.vars = E),
            (O = O || E.animation),
            'refreshPriority' in E &&
              ((Qe = 1), -9999 === E.refreshPriority && (nt = Ce)),
            (c.tweenScroll = c.tweenScroll || {
              top: rc(be, Ye),
              left: rc(be, ze),
            }),
            (Ce.tweenTo = B = c.tweenScroll[he.p]),
            ...
            O &&
              ...
              (O.scrollTrigger = Ce).scrubDuration(P),
              (w = 0),
              (a = a || O.vars.id)),
            ue &&
              ((Va(ue) && !ue.push) || (ue = { snapTo: ue }),
              'scrollBehavior' in We.style &&
                Fe.set(me ? [We, Xe] : be, { scrollBehavior: 'auto' }),
              Ie.forEach(function (e) {
                return (
                  Ta(e) &&
                  e.target === (me ? Ne.scrollingElement || Xe : be) &&
                  (e.smooth = !1)
                )
              }),
              (p = Ta(ue.snapTo)
                ...
                : Fe.utils.snap(ue.snapTo)),
              (g = ue.duration || { min: 0.1, max: 2 }),
              (g = Va(g) ? Ve(g.min, g.max) : Ve(g, g)),
              (te = Fe.delayedCall(ue.delay || o / 2 || 0.1, function () {
                var e = Be(),
                  t = it() - Ee < 500,
                  r = B.tween
                if (
                  ...
                  var n = (e - R) / N,
                    ...
                    a = Fe.utils.clamp(-n, 1 - n, (ct(i / 2) * i) / 0.185),
            ...
            (i =
              (i =
                (ie = Ce.trigger = J(ie || (!0 !== ae && ae))) &&
                ie._gsap &&
                ie._gsap.stRevert) && i(Ce)),
            (ae = !0 === ae ? ie : J(ae)),
            lt(S) && (S = { targets: ie, className: S }),
            ae &&
              (!1 === se ||
                se === bt ||
                (se =
              ...
              (n = Fe.core.getCache(ae)).spacer
                ...
                : (l &&
                  ...
                  (n.spacer = U = l || Ne.createElement('div')),
                  U.classList.add('pin-spacer'),
                  a && U.classList.add('pin-spacer-' + a),
                  (n.pinState = X = jc(ae))),
              !1 !== E.force3D && Fe.set(ae, { force3D: !0 }),
              (Ce.spacer = U = n.spacer),
              (r = mb(ae)),
              (m = r[se + he.os2]),
              (G = Fe.getProperty(ae)),
              (b = Fe.quickSetter(ae, he.a, yt)),
              gc(ae, U, r),
              (V = jc(ae))),
            _e)
          ) {
            ...
            ;(q = this.markerStart = Db('start', a, u, he, e, t, 0, de)),
              ...
              de && (T = Fe.quickSetter([q, L], he.a, yt)),
              ye ||
                ...
                Fe.set([Y, F], { force3D: !0 }),
                (y = Fe.quickSetter(Y, he.a, yt)),
                (x = Fe.quickSetter(F, he.a, yt)))
          }
          if (de) {
          ...
          if (
            ...
            (Ce.revert = function (e, t) {
              ...
              r !== Ce.isReverted &&
                (r &&
                  ((re = Math.max(Be(), Ce.scroll.rec || 0)),
                  (Oe = Ce.progress),
                  (ne = O && O.progress())),
                q &&
                  [q, L, Y, F].forEach(function (e) {
            ...
            (Ce.refresh = function (e, t, r, n) {
              if ((!Ke && Ce.enabled) || t)
                if (ae && e && at) wb(ScrollTrigger, 'scrollEnd', Ob)
                  ...
                  !tt && Se && Se(Ce),
                    (Ke = Ce),
                    B.tween && !r && (B.tween.kill(), (B.tween = 0)),
                    ee && ee.pause(),
                  ...
                  var o,
                    ...
                    k = (Ce.pinnedContainer =
                      E.pinnedContainer && J(E.pinnedContainer, Ce)),
                    P = (ie && Math.max(0, Tt.indexOf(Ce))) || 0,
                    M = P
                  for (
                    _e &&
                    Va(r) &&
                    ((h = Fe.getProperty(Y, he.p)),
                    (v = Fe.getProperty(F, he.p)));
                    M--;

                  )
                    (c = Tt[M]).end || c.refresh(0, 1) || (Ke = Ce),
                      !(u = c.pin) ||
                        (u !== ie && u !== ae && u !== k) ||
                        c.isReverted ||
                  ...
                  if (
                    ...
                    Ce._endClamp &&
                      !tt &&
                      ((Ce._endClamp = I || -0.001),
                      (I = Math.min(I, Qa(be, he)))),
                    (N = I - R || ((R -= 0.01) && 0.001)),
                    x &&
                      (Oe = Fe.utils.clamp(0, 1, Fe.utils.normalize(R, I, re))),
                    (Ce._pinPush = _),
                    q &&
                      w &&
                      (((o = {})[he.a] = '+=' + w),
                      k && (o[he.p] = '-=' + Be()),
                      Fe.set([q, L], o)),
                    !ae || ($e && Ce.end >= Qa(be, he)))
                  ) {
                    if (ie && Be() && !de)
                      for (i = ie.parentNode; i && i !== We; )
                        i._pinOffset &&
                          ((R -= i._pinOffset), (I -= i._pinOffset)),
                          (i = i.parentNode)
                  } else
                    (o = mb(ae)),
                      (s = he === Ye),
                      ...
                      !y &&
                        1 < I &&
                        ((g = {
                          style: (g = (me ? Ne.scrollingElement || Xe : be)
                            .style),
                      ...
                      (f = ye && K(be, s ? ze : Ye)()),
                      se &&
                        (((Z = [se + he.os2, N + _ + yt]).t = U),
                        (M = se === vt ? qb(ae, he) + N + _ : 0) &&
                          (Z.push(he.d, M + yt),
                          'auto' !== U.style.flexBasis &&
                            (U.style.flexBasis = M + yt)),
                        Mt(Z),
                        k &&
                          Tt.forEach(function (e) {
                            e.pin === k &&
                      ...
                      ye &&
                        (((l = {
                          ...
                          Math.ceil(i.width) + yt),
                        (l[ft] = l.maxHeight = Math.ceil(i.height) + yt),
                        (l[bt] =
                          l[bt + gt] =
                          l[bt + dt] =
                          l[bt + ht] =
                  ...
                  p &&
                    ...
                    (Ce.end = I),
                    (A = D = tt ? re : Be()),
                    de || tt || (A < re && Be(re), (Ce.scroll.rec = 0)),
                    Ce.revert(!1, !0),
                    (Ee = it()),
                    ...
                    (x || Oe !== Ce.progress || de) &&
                      (O &&
                        ...
                        O.totalProgress(
                          de && R < -0.001 && !Oe
                            ? Fe.utils.normalize(R, I, 0)
                            : Oe,
                          !0
                        ),
                      (Ce.progress = x || (A - R) / N === Oe ? 0 : Oe)),
            ...
            (Ce.getTrailing = function (t) {
              var e = Tt.indexOf(Ce),
                r =
                  0 < Ce.direction ? Tt.slice(0, e).reverse() : Tt.slice(e + 1)
              return (
                lt(t)
                  ? r.filter(function (e) {
            ...
            (Ce.update = function (e, t, r) {
              if (!de || r || e) {
                ...
                if (
                  ...
                  !ue || B.tween || Ke || ot || te.restart(!0),
                    S &&
                      (s || (ce && d && (d < 1 || !et))) &&
                      Je(S.targets).forEach(function (e) {
                    ...
                    a && !Ke
                      ? (ve &&
                        ...
                        (!s && et) ||
                          (k && s && Xa(Ce, k),
                          xe[o] && Xa(Ce, xe[o]),
                          ce && (1 === d ? Ce.kill(!1, 1) : (xe[o] = 0)),
                          s || (xe[(o = 1 === d ? 1 : 3)] && Xa(Ce, xe[o]))),
                        pe &&
                          !n &&
            ...
            (Ce.enable = function (e, t) {
              Ce.enabled ||
                ...
                !1 !== e && ((Ce.progress = Oe = 0), (A = D = Me = Be())),
                !1 !== t && Ce.refresh())
            }),
            ...
            (Ce.adjustPinSpacing = function (e) {
              if (Z && e) {
                ...
                ;(Z[t] = parseFloat(Z[t]) + e + yt),
                  (Z[1] = parseFloat(Z[1]) + e + yt),
                  Mt(Z)
              }
            }),
            (Ce.disable = function (e, t) {
              if (
                ...
                te && (te.pause(), B.tween && B.tween.kill() && (B.tween = 0)),
                !me)
              ) {
      ...
      (ScrollTrigger.disable = function disable(t, r) {
        ;(st = 0),
          ...
          xb(Ne, 'scroll', Jb),
          clearInterval(u),
          xb(Ne, 'touchcancel', Ha),
          xb(We, 'touchstart', Ha),
          vb(xb, Ne, 'pointerdown,touchstart,mousedown', Fa),
          vb(xb, Ne, 'pointerup,touchend,mouseup', Ga),
          c.kill(),
          Ra(xb)
      ...
      (ScrollTrigger.enable = function enable() {
        if (
          ((He = window),
          (Ne = document),
          (Xe = Ne.documentElement),
          (We = Ne.body),
          Fe &&
            ((Je = Fe.utils.toArray),
            (Ve = Fe.utils.clamp),
            (x = Fe.core.context || Ha),
            (Ze = Fe.core.suppressOverwrites || Ha),
            (w = He.history.scrollRestoration || 'auto'),
            (Q = He.pageYOffset),
            Fe.core.globals('ScrollTrigger', ScrollTrigger),
            We))
        ) {
          ;(st = 1),
          ...
          for (
            o.revert ||
              ...
              wb(Ne, 'touchcancel', Ha),
              wb(We, 'touchstart', Ha),
              vb(wb, Ne, 'pointerdown,touchstart,mousedown', Fa),
              vb(wb, Ne, 'pointerup,touchend,mouseup', Ga),
              f = Fe.utils.checkPrefix('transform'),
              ee.push(f),
              s = it(),
              c = Fe.delayedCall(0.2, kt).pause(),
              g = [
                Ne,
                'visibilitychange',
                function () {
      ...
      (ScrollTrigger.scrollerProxy = function scrollerProxy(e, t) {
        var r = J(e),
          ...
          o = La(r)
        ~n && Ie.splice(n, o ? 6 : 2),
          t && (o ? qe.unshift(He, t, We, t, Xe, t) : qe.unshift(r, t))
      }),
      ...
      (ScrollTrigger.isInViewport = function isInViewport(e, t, r) {
        var n = (lt(e) ? J(e) : e).getBoundingClientRect(),
          o = n[r ? ut : ft] * t || 0
        return r
          ? 0 < n.right - o && n.left + o < He.innerWidth
          : 0 < n.bottom - o && n.top + o < He.innerHeight
      }),
  ...
  function Bc(e) {
    ...
    return (
      ...
      (e.onPress = function () {
        o = !1
        var e = y
        ;(y = Ia(((He.visualViewport && He.visualViewport.scale) || 1) / x)),
          a.pause(),
          e !== y && uc(p, 1.01 < y || (!f && 'x')),
          (c = m()),
          (u = b()),
      ...
      (e.onEnable = function () {
        uc(p, !f && 'x'),
          ne.addEventListener('refresh', Iq),
          wb(He, 'resize', Iq),
          b.smooth &&
      ...
      (e.onDisable = function () {
        uc(p, !0),
          xb(He, 'resize', Iq),
          ne.removeEventListener('refresh', Iq),
          T.kill()
      }),
